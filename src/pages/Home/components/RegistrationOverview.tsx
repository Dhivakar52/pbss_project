          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800/40 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all">
              ...
              <div className="shrink-0 self-end md:self-center">
                ...
                >
                  <Printer className="h-3.5 w-3.5" /> Print Track Sheet 1
                </button>
              </div>
            </div>
            ...
            {onPrintTrackSheet2 && (
              <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800/40 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all">
                <div className="flex items-start gap-3.5">
                  <div className="w-11 h-11 rounded-xl bg-cyan-50 dark:bg-cyan-950/60 text-cyan-600 dark:text-cyan-400 flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800/40 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all">
              <div className="flex items-start gap-3.5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                    Download and print a copy of your completed registration form 1.
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800/40 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all">
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                      Print registration form with Parent & Guardian details table and inline Parent Details.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800/40 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all">
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                      Print registration form with compact multi-column Parent Details table.
                    </p>
                  </div>
                </div>
